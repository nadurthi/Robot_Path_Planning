...
redoSATTRAJ=1;
filename='SavedData/SATELLIIETASKING_MAIN_sat_1__greedytime_50sats2rad.mat';
...
for i=1:1:Constants.Nsat
    ...
    Satellites{i}.Qmeas=0.00000001*blkdiag(0.01,0.01,0.01,1e-8,1e-8,1e-8);
...
hm = HeatMap(M,'RowLabels',1:1:Constants.Nsat,'ColumnLabels',1:1:Constants.Ntimesteps,'Colormap','redbluecmap','Symmetric',0,'ColumnLabelsRotate',1);
...
hm = HeatMap(M,'RowLabels',1:1:Constants.Nsat,'ColumnLabels',2:1:Constants.Ntimesteps,'Colormap','redbluecmap','Symmetric',0,'ColumnLabelsRotate',1);
addXLabel(hm, 'time steps --> ', 'FontSize', 26, 'FontAngle', 'Italic')
addYLabel(hm, 'Object Id ', 'FontSize', 26, 'FontAngle', 'Italic')
