function [MeasPairs,NewSigSet]=SatRadarPair_modf_orb(MeasPairs,XsigSat,SigSet,Radmodel,curk,fink,Tvec,method,FIMmethod)
...
if curk>SigSet{Ns,3}
x=propagate_sigma_pts_2body_orb(x,tT);
end
