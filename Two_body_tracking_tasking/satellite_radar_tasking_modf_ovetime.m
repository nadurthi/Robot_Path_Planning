...
for i=1:1:5
  ...
  R=blkdiag((0.1)^2,(0.1*pi/180)^2,(0.1*pi/180)^2);
...
tic
 %Generate the MeasPairs
     if k==lk   
     [MeasPairs_ut,SigSet_ut]=SatRadarPair_modf_ovetime(MeasPairs_ut,XsigSat_ut,SigSet_ut,Radmodel,k,k+LookAheadNt,Tvec,'ut');
%      [MeasPairs_cut8,SigSet_cut8]=SatRadarPair_modf_overtime(MeasPairs_cut8,XsigSat_cut8,SigSet_cut8,Radmodel,k,k,Tvec,'cut8','MI');
     lk=k+LookAheadNt+1;
     end
% Measurement update only for the MeasPairs{k}
     [XsigSat_ut,SigSet_ut]=Meas_Update_mu_P_all_sats_modf_ovetime(XsigSat_ut,MeasPairs_ut,SigSet_ut,Radmodel,k,Tvec,'ut',ytruth);
...
save('Sat3Dtasking_estimation_sim1','XsigSat_ut','XsigSat_cut8','MeasPairs_ut','MeasPairs_cut8','Hut','Hcut8','Huterr','Hcut8err','Tvec','ytruth','Xsat0','Radmodel')